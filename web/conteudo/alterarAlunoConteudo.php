                    ...
                    <fieldset>
                      <ol>
                        ...
                        <li class="form-row text-input-row">
                            ...
                            if(isset($alunoRetornado)) echo $alunoRetornado->getNome() ?>" class="text-input" style="width: 300px">
                        </li>

                        <li class="form-row text-input-row">
                          <label>CPF</label>
                          <input type="text" name="cpf" value="<?php 
                        if(isset($alunoRetornado)) echo $alunoRetornado->getCpf() ?>" class="text-input" style="width: 300px">  &nbsp;&nbsp;<span style="color: #c4c4c4">Ex. 111.111.111-11</span>
                    </li>
                    
                    <li class="form-row text-input-row">
                          <label>Endereço</label>
                          <input type="text" name="endereco" value="<?php 
                        if(isset($alunoRetornado)) echo $alunoRetornado->getEndereco() ?>" class="text-input" style="width: 300px">
                    </li>
                        
                     <li class="form-row text-input-row">
                          <label>Telefone</label>
                          <input type="text" name="telefone" value="<?php 
                        if(isset($alunoRetornado)) echo $alunoRetornado->getTelefone() ?>" class="text-input" style="width: 300px"> &nbsp;&nbsp;<span style="color: #c4c4c4">Ex. (DD) 1111-1111</span>
                    </li>
                    
                     <li class="form-row text-input-row">
                          <label>E-mail</label>
                          <input type="text" name="email" value="<?php 
                        if(isset($alunoRetornado)) echo $alunoRetornado->getEmail() ?>" class="text-input" style="width: 300px">
                    </li>
