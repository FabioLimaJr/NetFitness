        ...
        ?> 
         ...
         <fieldset>
           <ol>
                ...
                <li class="form-row text-input-row">
                    <label>Data</label>
                    <input type="text" name="data" id="dataPicked" value="<?php if(isset($noticia)) echo ExpressoesRegulares::inverterData($noticia->getData()) ?>" class="text-input" style="width: 300px">
                </li>
